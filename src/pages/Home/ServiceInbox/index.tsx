        ...
        <div className="container">
          <div className="flex justify-center lg:flex-row flex-col">
            <div className="flex flex-col align-center lg:w-[679px]">
              <img src={titleServiceInboxSrc} className="h-[35px] lg:h-[60px] mb-[20px]" data-aos="fade-up" data-aos-delay="500" />
              <div className="flex justify-center">
                <div className="lg:max-w-[479px] max-w-[353px]">
                  <div className="text-center lg:text-[24px] font-bold text-[20px]" data-aos="fade-up" data-aos-delay="700">您的聲音，我們的行動！</div>
                  <div className="lg:font-bold text-center lg:text-[24px] text-[15px] font-medium mt-[10px]" data-aos="fade-up" data-aos-delay="900">親愛的鄉親，每一位市民的意見都是我們社區前進的原動力。無論大小事，我都誠摯希望聽到您的建議。分享您的想法，一同為我們的未來打造更美好！</div>
                </div>
              </div>
            </div>
            <div className="lg:w-[555px] flex justify-center mt-[15px] lg:mt-0" data-aos="fade-up" data-aos-delay="1200">
              <form
