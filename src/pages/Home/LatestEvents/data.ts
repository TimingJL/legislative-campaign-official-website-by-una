import carFirstSrc from 'src/assets/images/event-cat-first.png';
import modelSrc from 'src/assets/images/event-model.png';
import streetSrc from 'src/assets/images/event-street.png';
